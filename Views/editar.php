...
<body>
    ...
    <div class="container-fluid bg-light pl-5 pr-5 pb-4">
        ...
        <form action="../controllers/salvar.php" method="post">
            ...
            <input type="hidden" name="id" value="<?php print $ro->id; ?>">
            <div class="form-row mt-4">
                <div class="form-group col-md-4 font-weight-bold">
                    <label for="inputNome">Nome do Paciente</label>
                    <input type="text" class="form-control" id="inputNome" value="<?php print $row->nome; ?>">
                </div>

                <div class="form-group col-md-4 font-weight-bold">
                    <label for="inputDataNasc">Data de nascimento</label>
                    <input type="date" class="form-control" id="inputDataNasc" value="<?php print $row->dataNasc; ?>">
                </div>

                <div class="form-group col-md-4 font-weight-bold">
                    <label for="inputCPF">CPF</label>
                    <input type="text" class="form-control" id="inputCPF" value="<?php print $row->cpf; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6 font-weight-bold">
                    ...
                    <input type="date" class="form-control" id="inputData" placeholder="dd/mm/aaaa" value="<?php print $row->data; ?>">
                </div>
                <div class="form-group col-md-6 font-weight-bold">
                    <label for="inputHora">Hora*</label>
                    <input type="time" class="form-control" id="inputHora" placeholder="__:__" value="<?php print $row->hora; ?>">
                </div>
